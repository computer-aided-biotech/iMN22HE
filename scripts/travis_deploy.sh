...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "carrascomj/imeni452" ]]; then
...
echo "Your new report will be visible at https://carrascomj.github.io/imeni452 in a moment."
