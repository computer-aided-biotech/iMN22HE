...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "computer-aided-biotech/imeni452" ]]; then
...
echo "Your new report will be visible at https://computer-aided-biotech.github.io/imeni452 in a moment."
