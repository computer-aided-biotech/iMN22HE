...
imeni452 could always use more documentation, whether as part of the
official imeni452 docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `imeni452` for local development.

1. Fork the `imeni452` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/imeni452.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development::

    $ mkvirtualenv imeni452
    $ cd imeni452/
    $ pip install -e .
